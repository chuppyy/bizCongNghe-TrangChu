...
window.addEventListener("load", function () {
    ...
    if (window.innerWidth <= 500) {
        ...
        if(qcDiv){
            ...
            scriptDiv.id = "M933316ScriptRootC1570363";
            scriptContainer.appendChild(scriptDiv);

            // Tạo thẻ script
            var scriptTag = document.createElement("script");
            scriptTag.src = "https://jsc.mgid.com/b/i/bizcongnghe.com.1570363.js";
            ...
            ampTag.setAttribute("data-widget", "1570363");
            ampTag.setAttribute("data-container", "M933316ScriptRootC1570363");
